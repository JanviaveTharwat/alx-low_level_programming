...
/**
 * check97 - checks for the correct number
...
/**
 * check98 - checks that file can be read
...
/**
 * check99 - checks that file vwas created
 * @check: checks if true of false
 * @file: file name
 * @fd_from: file descriptor
 * @fd_to: file descriptor
...
/**
 * check100 - checks that file descriptors were closed
